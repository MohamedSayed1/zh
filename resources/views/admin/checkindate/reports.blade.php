            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-white table-panel" style="zoom: 1;overflow: scroll">
                    ...
                    <div class="inline-form1 opened" style="overflow: scroll">
                        <div class="col-md-11">
                            <form method="post" action="{{url('dashboard/appointment/search')}}">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" name="from_date" value="{{app('request')->input('from_date')}}" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" name="to_date" value="{{app('request')->input('to_date')}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <ul class="pagination pagination-blue margin-bottom-10">
                                        ...
                                        {{$appointments ? $appointments->links() :''}}
                                    </ul>
