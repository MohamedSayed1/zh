        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-white table-panel" style="zoom: 1; overflow: scroll">
                <div class="panel-heading">
                    <h4 class="panel-title"><span class="text-bold">Terms</span></h4>
                ...
                <div class="inline-form1  opened" style="overflow: scroll">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control"
                                               name="name" placeholder="Enter the name of term"
                                               value="{{old('name')!= null ? old('name') : $term->name}}">
                                        @error('name')
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" name="start_date"
                                               ...
                                               value="{{old('start_date')!= null ? old('start_date') : $term->start_date}}">
                                        @error('start_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" name="end_date"
                                               ...
                                               value="{{old('end_date')!= null ? old('end_date') : $term->end_date}}">
                                        @error('end_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                  ...
                  <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-12 ">
                                        <div class="btn-group">
                                            <a href="{{url('dashboard/terms')}}" class="btn btn-info inline-close">
                                                back
                                            </a>
                                        </div>
                                        <div class="btn-group">
