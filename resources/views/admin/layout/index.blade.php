            ...
            <div class="panel panel-default panel-white core-box">
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="padding-20 core-content">
                        ...
                        <span class="subtitle"> Lorem ipsum dolor sit amet, consectetuer adipiscing
											elit. </span>
                    </div>
                </div>
                ...
                <div class="e-slider owl-carousel owl-theme">
                    <div class="item">
                            ...
                            <div class="core-box">
                                ...
                                <div class="progress progress-xs transparent-black no-radius space5">
                                    <div aria-valuetransitiongoal="88"
                                         class="progress-bar progress-bar-success partition-white animate-progress-bar">
                                    </div>
                                </div>
                        ...
                        <div class="padding-10">
                            <span class="bold-text">1527</span><span class="text-light"> people share
												this goal </span>
                    ...
                    <div class="item">
                        <div class="panel-body">
                            <div class="core-box">
                                ...
                                <span class="text-light text-small block pull-right"> <i
                                            class="fa fa-clock-o"></i> 11 min ago </span>
                            </div>
                        </div>
                        <div class="padding-10">
                            <span class="bold-text">1527</span><span class="text-light"> people share
                    ...
                    <div class="item">
                        <div class="panel-body">
                            <div class="core-box">
                                ...
                                <span class="text-light text-small block pull-right"> <i
                                            class="fa fa-clock-o"></i> 27 min ago </span>
                            </div>
                        </div>
                        <div class="padding-10">
                            <span class="bold-text">1527</span><span class="text-light"> people share
                    ...
                    <div class="item">
                        <div class="panel-body">
                            <div class="core-box">
                                ...
                                <span class="text-light text-small block pull-right"> <i
                                            class="fa fa-clock-o"></i> 56 min ago </span>
                            </div>
                        </div>
                        <div class="padding-10">
                            <span class="bold-text">1527</span><span class="text-light"> people share
                    ...
                    <div class="e-slider owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="panel-body space10">
                                ...
                                <div class="note-content">
                                    ...
                                    Quis aute iure reprehenderit in <strong>voluptate velit</strong>
                            ...
                            <div class="panel-footer">
                                <div class="avatar-note">
                                    <img src="~/{{asset('panel/assets/images/avatar-2-small.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="panel-footer">
                                ...
                                <div class="avatar-note">
                                    <img src="~/{{asset('panel/assets/images/avatar-3-small.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="panel-footer">
                                ...
                                <div class="avatar-note">
                                    <img src="~/{{asset('panel/assets/images/avatar-4-small.jpg')}}" alt="">
                                </div>
                        ...
                        <li class="panel-tools">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-light pull-right" role="menu">
                                    ...
                                    <li>
                                        <a class="panel-config" href="#panel-config"
                                           data-toggle="modal">
                                        ...
                                        <div class="e-slider owl-carousel owl-theme"
                                            ...
                                            <div class="item">
                                                <div
                                                    ...
                                                    <span class="text-light text-extra-small">1
																		hour</span>
                                                </div>
                                                <div class="inline-block padding-10">
                                                    <span class="bold-text text-small">NETWORKING</span>
                                                    <span class="text-light text-small">Out to design
																		conference</span>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div
                                                    ...
                                                    <span class="text-light text-extra-small">30
																		mins</span>
                                                </div>
                                                <div class="inline-block padding-10">
																	<span class="bold-text text-small">BOOTSTRAP
																		SEMINAR</span>
                                                    <span class="text-light text-small">Problem
																		Solving</span>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div
                                                    ...
                                                    <span class="text-light text-extra-small">2
																		hour</span>
                                                </div>
                                                <div class="inline-block padding-10">
																	<span class="bold-text text-small">Lunch with
																		Nicole</span>
                                                    <span class="text-light text-small">Next on
																		Tuesday</span>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="row">
                    ...
                    <div class="panel panel-blue">
                        <div class="panel-body padding-20 text-center">
                            <div class="space10">
                                ...
                                <h3 class="text-white no-margin"><span
                                            class="text-small">&#36;</span>1,450</h3>
                                253 Sales
                            </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-body padding-20 text-center">
                            <div class="space10">
                                ...
                                <h3 class="text-white no-margin"><span
                                            class="text-small">&#36;</span>1,250</h3>
                                198 Sales
                            </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body no-padding">
                    <div class="padding-10">
                        <img width="50" height="50" alt="" class="img-circle pull-left"
                             src="~/{{asset('panel/assets/images/avatar-1-big.jpg')}}">
                    ...
                    <div class="clearfix padding-5 space5">
                        ...
                        <div class="col-xs-4 text-center no-padding">
                            <a href="#" class="text-dark"><i class="fa fa-comment-o text-azure"></i>
                                544</a>
                        </div>
                    </div>
                            ...
                            <div id="users_tab_example1" class="tab-pane padding-bottom-5 active">
                                <div class="panel-scroll height-230">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            <td class="center"><img
                                                        src="~/{{asset('panel/assets/images/avatar-1.jpg')}}"
                                                        class="img-circle" alt="image" /></td>
                                            <td><span class="text-small block text-light">UI
																		Designer</span><span class="text-large">Peter
																		Clark</span><a href="#" class="btn"><i
                                                            class="fa fa-pencil"></i></a></td>
                                            <td class="center">
                                                <div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-transparent-grey dropdown-toggle btn-sm"
                                        ...
                                        <tr>
                                            <td class="center"><img
                                                        src="~/{{asset('panel/assets/images/avatar-2.jpg')}}"
                                                        class="img-circle" alt="image" /></td>
                                            <td><span class="text-small block text-light">Content
																		Designer</span><span class="text-large">Nicole
																		Bell</span><a href="#" class="btn"><i
                                                            class="fa fa-pencil"></i></a></td>
                                            <td class="center">
                                                <div>
                                                    <div class="btn-group">
                                        ...
                                        <tr>
                                            <td class="center"><img
                                                        src="~/{{asset('panel/assets/images/avatar-3.jpg')}}"
                                                        class="img-circle" alt="image" /></td>
                                        ...
                                        <tr>
                                            <td class="center"><img
                                                        src="~/{{asset('panel/assets/images/avatar-5.jpg')}}"
                                                        class="img-circle" alt="image" /></td>
                                            <td><span class="text-small block text-light">Senior
																		Designer</span><span class="text-large">Kenneth
																		Ross</span><a href="#" class="btn"><i
                                                            class="fa fa-pencil"></i></a></td>
                                            <td class="center">
                                                <div>
                                                    <div class="btn-group">
                                        ...
                                        <tr>
                                            <td class="center"><img
                                                        src="~/{{asset('panel/assets/images/avatar-4.jpg')}}"
                                                        class="img-circle" alt="image" /></td>
                                            <td><span class="text-small block text-light">Web
																		Editor</span><span class="text-large">Ella
																		Patterson</span><a href="#" class="btn"><i
                                                            class="fa fa-pencil"></i></a></td>
                                            <td class="center">
                                                <div>
                                                    <div class="btn-group">
                        ...
                        <div class="overlayer bottom-left fullwidth">
                            <div class="overlayer-wrapper">
                                <div class="padding-20">
                                    ...
                                    <h5 class="text-white">Take a look at what other users are uploading
                                        right now</h5>
                                </div>
                            </div>
                        </div>
                        <div class="e-slider owl-carousel owl-theme portfolio-grid portfolio-hover"
                             data-plugin-options='{"pagination": false, "stopOnHover": true}'>
                            <div class="item">
                                <img src="~/{{asset('panel/assets/images/image01.jpg')}}" alt="">
                                <div class="caption">
                            ...
                            <div class="item">
                                <img src="~/{{asset('panel/assets/images/image02.jpg')}}" alt="">
                                <div class="caption">
                                    <h2 class="caption-title">Hover Style #10</h2>
                                    <p class="caption-description">
                                        A wonderful serenity has taken possession of my entire soul,
                            ...
                            <div class="item">
                                <img src="~/{{asset('panel/assets/images/image03.jpg')}}" alt="">
                                <div class="caption">
                                    <h2 class="caption-title">Hover Style #10</h2>
                                    <p class="caption-description">
                                        A wonderful serenity has taken possession of my entire soul,
                            ...
                            <div class="item">
                                <img src="~/{{asset('panel/assets/images/image04.jpg')}}" alt="">
                                <div class="caption">
                                    <h2 class="caption-title">Hover Style #10</h2>
                                    <p class="caption-description">
                                        A wonderful serenity has taken possession of my entire soul,
                    ...
                    <div class="partition partition-white padding-15">
                        <div class="navigator">
                            <a href="#" class="circle-50 partition-white owl-prev"><i
                                        class="fa fa-chevron-left text-extra-large"></i></a>
                            <a href="#" class="circle-50 partition-white owl-next"><i
                            ...
                            <div class="pull-left">
												<span
                                                        class="background-dark padding-5 radius-5 text-small inline-block"><i
                                                            class="fa fa-clock-o"></i> 43 days</span>
                                <span
                                        class="background-dark padding-5 radius-5 text-small inline-block"><i
                                    ...
                                    <ul class="todo">
                                                ...
                                                <div class="padding-horizontal-5">
                                                    ...
                                                    <div class="block">
																		<span class="desc text-small text-light"><i
                                                                                    class="fa fa-clock-o"></i> 13:00 PM
																			Today</span>
                                        ...
                                        <li>
                                            <div class="todo-actions">
                                                ...
                                                <div class="padding-horizontal-5">
                                                    <div class="block space5">
																		<span class="desc">New frontend
																			layout</span><span
                                                                class="label label-danger"> today</span>
                                                    </div>
                                                    <div class="block">
																		<span class="desc text-small text-light"><i
                                                                                    class="fa fa-clock-o"></i> 20:00 PM
																			Today</span>
                                                        <div class="btn-group btn-group-sm todo-tools">
                                                            <a class="btn" href="javascript:;">
                                                                <i class="fa fa-pencil-square-o"></i>
                                        ...
                                        <li>
                                            <div class="todo-actions">
                                                ...
                                                <div class="padding-horizontal-5">
                                                    <div class="block space5">
                                                        <span class="desc">Staff Meeting</span><span
                                                                class="label label-success"> this
																			week</span>
                                                    </div>
                                                    <div class="block">
																		<span class="desc text-small text-light"><i
                                                                                    class="fa fa-clock-o"></i> 12:00 AM this
																			week</span>
                                                        <div class="btn-group btn-group-sm todo-tools">
                                                            <a class="btn" href="javascript:;">
                                                                <i class="fa fa-pencil-square-o"></i>
                ...
                <div class="panel-heading border-light">
                    ...
                    <ul class="panel-heading-tabs border-light">
                        ...
                        <li>
                            <div class="rate">
                                <i class="fa fa-caret-up text-green"></i><span
                                        class="value">11</span><span class="percentage">%</span>
                            </div>
                        </li>
                        <li class="panel-tools">
                            <div class="dropdown">
