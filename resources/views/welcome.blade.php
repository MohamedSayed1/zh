...
<div class="main-wrapper">
    ...
    <div class="main-container inner" style="margin-left: 0 !important;">
        <!-- start: PAGE -->
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-white table-panel" style="zoom: 1;">
                            <div class="panel-heading">
                                <h4 class="panel-title"> <span class="text-bold"> Download Application</span></h4>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-push-3 text-center">
                                    <h3>
                                        ...
                                        <br>
                                        Please download the application to be able to access your account
                                        </h3>
                                    <button class="app-icon">
                                        <img class="img-responsive" src="{{asset('panel/assets/images/a1.png')}}">
                                    </button>
                                    <button class="app-icon">
                                        <img class="img-responsive" src="{{asset('panel/assets/images/a2.png')}}">
